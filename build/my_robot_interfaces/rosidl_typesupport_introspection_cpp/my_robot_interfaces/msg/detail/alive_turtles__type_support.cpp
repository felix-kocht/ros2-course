...
size_t size_function__AliveTurtles__alive_turles(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<geometry_msgs::msg::Vector3> *>(untyped_member);
  return member->size();
}

const void * get_const_function__AliveTurtles__alive_turles(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__AliveTurtles__alive_turles(void * untyped_member, size_t index)
{
  auto & member =
...
void fetch_function__AliveTurtles__alive_turles(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Vector3 *>(
    get_const_function__AliveTurtles__alive_turles(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Vector3 *>(untyped_value);
  value = item;
}

void assign_function__AliveTurtles__alive_turles(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Vector3 *>(
    get_function__AliveTurtles__alive_turles(untyped_member, index));
  const auto & value = *reinterpret_cast<const geometry_msgs::msg::Vector3 *>(untyped_value);
  item = value;
}

void resize_function__AliveTurtles__alive_turles(void * untyped_member, size_t size)
{
  auto * member =
    reinterpret_cast<std::vector<geometry_msgs::msg::Vector3> *>(untyped_member);
  member->resize(size);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AliveTurtles_message_member_array[1] = {
  {
    ...
    offsetof(my_robot_interfaces::msg::AliveTurtles, alive_turles),  // bytes offset in struct
    nullptr,  // default value
    size_function__AliveTurtles__alive_turles,  // size() function pointer
    get_const_function__AliveTurtles__alive_turles,  // get_const(index) function pointer
    get_function__AliveTurtles__alive_turles,  // get(index) function pointer
    fetch_function__AliveTurtles__alive_turles,  // fetch(index, &value) function pointer
    assign_function__AliveTurtles__alive_turles,  // assign(index, value) function pointer
    resize_function__AliveTurtles__alive_turles  // resize(index) function pointer
  }
};
