...
bool my_robot_interfaces__msg__alive_turtles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // alive_turles
    PyObject * field = PyObject_GetAttrString(_pymsg, "alive_turles");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'alive_turles'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    if (!geometry_msgs__msg__Vector3__Sequence__init(&(ros_message->alive_turles), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create geometry_msgs__msg__Vector3__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    geometry_msgs__msg__Vector3 * dest = ros_message->alive_turles.data;
...
{
  /* NOTE(esteve): Call constructor of AliveTurtles */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.msg._alive_turtles");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AliveTurtles");
  ...
  {  // alive_turles
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->alive_turles.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "alive_turles", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
