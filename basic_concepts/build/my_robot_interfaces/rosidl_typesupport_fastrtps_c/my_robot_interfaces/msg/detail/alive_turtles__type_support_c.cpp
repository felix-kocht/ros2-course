...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // alive_turles
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: alive_turles
  {
    ...
    auto array_ptr = ros_message->alive_turles.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: alive_turles
  {
    ...
    if (ros_message->alive_turles.data) {
      geometry_msgs__msg__Vector3__Sequence__fini(&ros_message->alive_turles);
    }
    if (!geometry_msgs__msg__Vector3__Sequence__init(&ros_message->alive_turles, size)) {
      fprintf(stderr, "failed to create array for field 'alive_turles'");
      return false;
    }
    auto array_ptr = ros_message->alive_turles.data;
    for (size_t i = 0; i < size; ++i) {
