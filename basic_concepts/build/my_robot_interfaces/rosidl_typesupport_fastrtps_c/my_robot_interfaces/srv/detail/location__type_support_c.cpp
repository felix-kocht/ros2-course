...
#include "my_robot_interfaces/srv/detail/location__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // location
...
using _Location_Request__ros_msg_type = my_robot_interfaces__srv__Location_Request;
...
static uint32_t _Location_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__srv__Location_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces__srv__Location_Request;
    is_plain =
      (
...
static size_t _Location_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__srv__Location_Request(
...
using _Location_Response__ros_msg_type = my_robot_interfaces__srv__Location_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interfaces__srv__Location_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces__srv__Location_Response;
    is_plain =
      (
...
static size_t _Location_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interfaces__srv__Location_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "my_robot_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "my_robot_interfaces/srv/location.h"
